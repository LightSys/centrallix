...
//
// WARNING: Saving this file in text mode (at least in vs code)
// will vonvert the invalid 0xFF character into the unicode sybol 
// �. If this happens, use a hex editor to convert it back into 0xFF

$Version=2$
Page1 "widget/page"
    {
    title="Test UTF-8 #01 -�Invalid UTF-8";
