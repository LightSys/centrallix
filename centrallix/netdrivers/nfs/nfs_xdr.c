...
bool_t
xdr_read_ok (XDR *xdrs, read_ok *objp)
{
	register int32_t *buf;
...
xdr_readres (XDR *xdrs, readres *objp)
{
	...
	switch (objp->status) {
	case NFS_OK:
		 if (!xdr_read_ok (xdrs, &objp->readres_u.data))
			 return FALSE;
		break;
	default:
		break;
...
bool_t
xdr_direntries (XDR *xdrs, direntries *objp)
{
	register int32_t *buf;
...
xdr_readdirres (XDR *xdrs, readdirres *objp)
{
	...
	switch (objp->status) {
	case NFS_OK:
		 if (!xdr_direntries (xdrs, &objp->readdirres_u.readdirok))
			 return FALSE;
		break;
	default:
		break;
...
bool_t
xdr_info_struct (XDR *xdrs, info_struct *objp)
{
	register int32_t *buf;
...
xdr_statfsres (XDR *xdrs, statfsres *objp)
{
	...
	switch (objp->status) {
	case NFS_OK:
		 if (!xdr_info_struct (xdrs, &objp->statfsres_u.info))
			 return FALSE;
		break;
	default:
		break;
...
bool_t
xdr_diropok_struct (XDR *xdrs, diropok_struct *objp)
{
	register int32_t *buf;
...
xdr_diropres (XDR *xdrs, diropres *objp)
{
	...
	switch (objp->status) {
	case NFS_OK:
		 if (!xdr_diropok_struct (xdrs, &objp->diropres_u.diropok))
			 return FALSE;
		break;
	default:
		break;
