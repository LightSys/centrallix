...
int cxss_generate_rsa_2048bit_keypair(char **privatekey, char **publickey, size_t *privatekey_len, size_t *publickey_len);
...
size_t cxss_encrypt_rsa(const char *data, size_t len, const char *publickey, size_t publickey_len, char **ciphertext);
