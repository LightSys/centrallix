...
int cxss_adduser(const char *cxss_userid, const unsigned char *encryption_key, size_t encryption_key_length, const unsigned char *salt, size_t salt_len);
int cxss_retrieve_user_privatekey(const char *cxss_userid, const char *user_key, size_t user_key_len, unsigned char **privatekey, int *privatekey_len);
int cxss_retrieve_user_publickey(const char *cxss_userid, unsigned char **publickey, int *publickey_len);
...
int cxss_get_resource(const char *cxss_userid, const char *resource_id, const unsigned char *user_key, size_t user_key_len, char **resource_username, char **resource_data);
