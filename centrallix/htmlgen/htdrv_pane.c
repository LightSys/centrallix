...
htpnRender(pHtSession s, pWgtrNode tree, int z)
	...
	if (style == 2) /* flat */
	    {
	    htrAddStylesheetItem(s,"\t#pn%POSmain { POSITION:absolute; VISIBILITY:inherit; overflow:hidden; LEFT:%INTpx; TOP:%INTpx; WIDTH: calc(%POSpx + (100% - %POSpx) * (%POSpx / %POSpx)); HEIGHT:%POSpx; Z-INDEX:%POS;}\n",id,x,y,preW,treePreW,flexW,treeFlexW,h,z);
