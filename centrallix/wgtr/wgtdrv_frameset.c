...
/*** wgtsetVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtsetVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtsetNew - after a node has been filled out with initial values,
...
wgtsetInitialize()
    {
    char* name="Frameset Driver";

	wgtrRegisterDriver(name, wgtsetVerify, wgtsetNew);
	wgtrAddType(name, "frameset");
