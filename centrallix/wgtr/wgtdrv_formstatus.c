...
/* 									*/
/* Module: 	wgtr/wgtdrv_formstatus.c						*/
...
/*** wgtfsNew - after a node has been filled out with initial values,
...
wgtfsInitialize()
    {
    char* name = "Form Status Driver";

	wgtrRegisterDriver(name, wgtfsVerify, wgtfsNew);
	wgtrAddType(name,"formstatus");
