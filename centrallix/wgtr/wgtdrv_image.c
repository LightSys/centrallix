...
/*** wgtimgVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtimgVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtimgNew - after a node has been filled out with initial values,
...
wgtimgInitialize()
    {
    char* name = "Image Driver";

	wgtrRegisterDriver(name, wgtimgVerify, wgtimgNew);
	wgtrAddType(name, "image");
