...
/*** wgtclVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtclVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtclNew - after a node has been filled out with initial values,
...
wgtclInitialize()
    {
	char* name = "Local Time Clock Driver";
	wgtrRegisterDriver(name, wgtclVerify, wgtclNew);
	wgtrAddType(name, "clock");
