 ...
 ***/
int
wgthintVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgthintNew - after a node has been filled out with initial values,
...
wgthintInitialize()
    {
    char* name = "Presentatin Hints pseudo-widget Driver";

	wgtrRegisterDriver(name, wgthintVerify, wgthintNew);
	wgtrAddType(name, "hints");
