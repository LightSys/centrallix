...
/*** wgtruleVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtruleVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtruleNew - after a node has been filled out with initial values,
...
wgtruleInitialize()
    {
    char* name="Declarative Rule Driver";

	wgtrRegisterDriver(name, wgtruleVerify, wgtruleNew);
	wgtrAddType(name, "rule");
