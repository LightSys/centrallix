...
/* 									*/
/* Module: 	wgtr/wgtdrv_connector.c						*/
...
/*** wgtconnVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtconnVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtconnNew - after a node has been filled out with initial values,
...
wgtconnInitialize()
    {
    char* name="Event-Action Connector Driver";

	wgtrRegisterDriver(name, wgtconnVerify, wgtconnNew);
	wgtrAddType(name, "connector");
