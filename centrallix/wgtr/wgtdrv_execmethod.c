...
/* 									*/
/* Module: 	wgtr/wgtdrv_execmethod.c						*/
...
/*** wgtexVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtexVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtexNew - after a node has been filled out with initial values,
...
wgtexInitialize()
    {
    char* name = "Method-Execution Widget";

	wgtrRegisterDriver(name, wgtexVerify, wgtexNew);
	wgtrAddType(name, "execmethod");
