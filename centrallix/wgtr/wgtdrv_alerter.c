...
/*** wgtalrtVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtalrtVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtalrtNew - after a node has been filled out with initial values,
...
wgtalrtInitialize()
    {
    char*   name = "DHTML Alert Widget";

	wgtrRegisterDriver(name, wgtalrtVerify, wgtalrtNew);
	wgtrAddType(name, "alerter");
