...
/* 									*/
/* Module: 	wgtr/wgtdrv_fileupload.c						*/
/* Author:	Brady Steed (BLS)		 			*/
/* Creation:	May 30, 2014						*/
/* Description:								*/
/************************************************************************/



/*** wgtfuVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtfuVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtfuNew - after a node has been filled out with initial values,
...
wgtfuInitialize()
    {
    char* name = "File Upload Driver";

	wgtrRegisterDriver(name, wgtfuVerify, wgtfuNew);
	wgtrAddType(name, "fileupload");
