...
/*** wgtcaVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtcaVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtcaNew - after a node has been filled out with initial values,
...
wgtcaInitialize()
	{
	char*	name = "Calendar View Driver";

	    wgtrRegisterDriver(name, wgtcaVerify, wgtcaNew);
	    wgtrAddType(name, "calendar");
