...
/*** wgttermVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgttermVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgttermNew - after a node has been filled out with initial values,
...
wgttermInitialize()
    {
    char* name = "Terminal Widget";

	wgtrRegisterDriver(name, wgttermVerify, wgttermNew);
	wgtrAddType(name, "terminal");
