...
/*** wgtvblVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtvblVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtvblNew - after a node has been filled out with initial values,
...
wgtvblInitialize()
    {
    char* name = "Variable Object Driver";

	wgtrRegisterDriver(name, wgtvblVerify, wgtvblNew);
	wgtrAddType(name, "variable");
