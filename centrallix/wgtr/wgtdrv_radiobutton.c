...
/* 									*/
/* Module: 	wgtr/wgtdrv_radiobutton.c						*/
...
/*** wgtrbVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtrbVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtrbNew - after a node has been filled out with initial values,
