...
/*** wgtspnrVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtspnrVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtspnrNew - after a node has been filled out with initial values,
...
wgtspnrInitialize()
    {
    char* name = "Spinner Box Driver";

	wgtrRegisterDriver(name, wgtspnrVerify, wgtspnrNew);
	wgtrAddType(name, "spinner");
