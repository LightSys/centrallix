...
/*** wgttmVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgttmVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgttmNew - after a node has been filled out with initial values,
...
wgttmInitialize()
    {
    char* name = "Nonvisual Timer Driver";

	wgtrRegisterDriver(name, wgttmVerify, wgttmNew);
	wgtrAddType(name, "timer");
