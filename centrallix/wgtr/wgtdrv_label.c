 ...
 ***/
int
wgtlblVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtlblNew - after a node has been filled out with initial values,
...
wgtlblInitialize()
    {
    char* name = "Single-line Label Driver";
    
	wgtrRegisterDriver(name, wgtlblVerify, wgtlblNew);
	wgtrAddType(name, "label");
