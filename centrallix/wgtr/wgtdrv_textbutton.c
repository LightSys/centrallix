...
/* 									*/
/* Module: 	wgtr/wgtdrv_textbutton.c						*/
...
/*** wgttbtnNew - after a node has been filled out with initial values,
...
wgttbtnInitialize()
    {
    char* name = "Text Button Widget Driver";

	wgtrRegisterDriver(name, wgttbtnVerify, wgttbtnNew);
