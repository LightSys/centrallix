...
/*** wgtdtVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtdtVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtdtNew - after a node has been filled out with initial values,
...
wgtdtInitialize()
    {
    char*   name="HTML Date/Time Widget Driver";

	wgtrRegisterDriver(name, wgtdtVerify, wgtdtNew);
	wgtrAddType(name, "datetime");
