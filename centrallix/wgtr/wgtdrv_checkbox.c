...
/*** wgtcbVerify - allows the driver to check elsewhere in the tree
 ...
 ***/
int
wgtcbVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgtcbNew - after a node has been filled out with initial values,
...
wgtcbInitialize()
    {
    char* name = "Checkbox Driver";
    
	wgtrRegisterDriver(name, wgtcbVerify, wgtcbNew);
	wgtrAddType(name, "checkbox");
