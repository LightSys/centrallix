...
/* 									*/
/* Module: 	wgtr/wgtdrv_template.c					*/
/* Author:	Greg Beeley (GRB)		 			*/
/* Creation:	Sept 26, 2005						*/
 ...
 ***/
int
wgttplVerify(pWgtrVerifySession s)
    {
    return 0;
    }


/*** wgttplNew - after a node has been filled out with initial values,
...
wgttplInitialize()
    {
    char* name = "Template pseudo-widget Driver";

	wgtrRegisterDriver(name, wgttplVerify, wgttplNew);
	wgtrAddType(name, "template");
