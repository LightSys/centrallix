...
void run_tests(void) {
    ...
    fprintf(stderr, "There should be two warnings after this line.\n");
    test(NULL, "", "");
    test("", "", "");
    ...
    /** Tests from examples in code comments above. **/
    ...
    /** Intereesting Edge Case: "McClellan" **/
     ...
     *** I guess we were both getting pretty tired.
     ***/
