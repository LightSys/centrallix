...
If you see python errors, check that `python3 --version` is at least `3.8`. Preferably, the version should be at least `3.12`; the version on which the script was written and tested. If you need to change your python version, you can use the command below to list all available python installations on your machine.
