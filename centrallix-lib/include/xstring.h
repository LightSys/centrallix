...
/** XString methods **/
int xsInit(pXString);
int xsDeInit(pXString);
int xsCheckAlloc(pXString, int addl_needed);
int xsConcatenate(pXString, char* text, int len);
int xsCopy(pXString, char* text, int len);
char* xsString(pXString);
char* xsStringEnd(pXString);
int xsPrintf(pXString, char* fmt, ...);
int xsConcatPrintf(pXString, char* fmt, ...);
int xsWrite(pXString, char* buf, int len, int offset, int flags);
int xsRTrim(pXString);
int xsLTrim(pXString);
int xsTrim(pXString);
int xsFind(pXString,char* find,int findlen, int offset);
int xsFindRev(pXString,char* find,int findlen, int offset);
int xsSubst(pXString, int offset, int len, char* rep, int replen);
int xsReplace(pXString, char* find, int findlen, int offset, char* rep, int replen);
int xsInsertAfter(pXString, char* ins, int inslen, int offset);
...
int xsQPrintf(pXString, char* fmt, ...);
int xsConcatQPrintf(pXString, char* fmt, ...);
