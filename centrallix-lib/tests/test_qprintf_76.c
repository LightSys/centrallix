 ...
 *** unsigned range rather than wrapping to a negative number the way %LL
 *** would.  Truncation, return values, and buffer accounting match the
 *** other source specifiers.
 ***/
static bool
doTest(void)
    {
