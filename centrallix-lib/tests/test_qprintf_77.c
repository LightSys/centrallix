...
/*** %BOOL prints "true" for a nonzero int and "false" for zero.  It behaves
 *** like the other source specifiers with respect to buffer truncation,
 *** return values, and conditional printing.
 ***/
static bool
doTest(void)
    {
